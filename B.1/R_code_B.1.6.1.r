...
img <- load.image("Files/Emperor Trump.jpeg")
#Delete b,g
img[, , 1, 2] <- 0
img[, , 1, 3] <- 0
...
msg("Creating directories and producing pictures for B.1.6.1.2...")
...
save_dir <- file.path(pic_dir, subDir = "B.1.6.1.2")
...
msg("Creating directories and producing pictures for B.1.6.1.3...")
save_dir <- file.path(pic_dir, subDir = "B.1.6.1.3")
dir.create(save_dir, showWarnings = FALSE)
setwd(save_dir)
...
#---------------------------------------------------------------------------------------------
#B.1.6.1.4
msg("Creating directories and computing errors for B.1.6.1.4...")
save_dir <- file.path(pic_dir, subDir = "B.1.6.1.4")
dir.create(save_dir, showWarnings = FALSE)
setwd(save_dir)
...
#---------------------------------------------------------------------------------------------
#B.1.6.1.5
msg("Creating directories and computing errors for B.1.6.1.5...")
save_dir <- file.path(pic_dir, subDir = "B.1.6.1.5")
dir.create(save_dir, showWarnings = FALSE)
setwd(save_dir)
